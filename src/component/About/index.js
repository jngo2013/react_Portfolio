  ...
  <div>
    <div className="container contact-form">
      ...
      <div className="row">
        ...
        <p>
        Prior to earning my certificate in Full-stack web development, I managed a boba shop at the University of California, Berkeley campus for three years. During this time, I was able to gain more experience in managing multiple priorities, working with a team, making decisions, and communicating effectively. Being a manager has allowed me to constantly grow in many skills such as managing employees, communicating effectively, and solving problems efficiently. I aim to utilize every skill that I have obtained from my previous fields to be of value to the web development community.</p>
      </div>
    </div>
  </div>
